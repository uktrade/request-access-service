...
class UserEndForm(GOVUKForm):
    user_email = forms.CharField(label='E-mail address of user who needs access', max_length=60, required=False, widget=widgets.TextInput())
    ...
    email = forms.CharField(label='Your email', max_length=60, widget=widgets.TextInput())
