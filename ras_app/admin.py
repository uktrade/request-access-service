...
class Rrquest_admin(admin.ModelAdmin):
	list_display = ('requestor', 'approver', 'signed_off', 'signed_off_on', 'reason', 'user_email', 'get_services')
...
class User_admin(admin.ModelAdmin):
	list_display = ('firstname', 'surname', 'email', 'end_date', 'get_requests')
